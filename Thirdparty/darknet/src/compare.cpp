...
void train_compare(char *cfgfile, char *weightfile)
{
    ...
    int imgs = 1024;
    listc *plistc = get_paths("data/compare.train.list");
...
void validate_compare(char *filename, char *weightfile)
{
    ...
    listc *plistc = get_paths("data/compare.val.list");
    //listc *plistc = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plistc);
    int N = plistc->size/2;
    free_list(plistc);
...
void SortMaster3000(char *filename, char *weightfile)
{
    ...
    listc *plistc = get_paths("data/compare.sort.list");
    //listc *plistc = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plistc);
    int N = plistc->size;
    free_list(plistc);
...
void BattleRoyaleWithCheese(char *filename, char *weightfile)
{
    ...
    listc *plistc = get_paths("data/compare.sort.list");
    //listc *plistc = get_paths("data/compare.small.list");
    //listc *plistc = get_paths("data/compare.cat.list");
    //listc *plistc = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plistc);
    int N = plistc->size;
    int total = N;
