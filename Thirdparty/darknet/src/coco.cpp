...
void validate_coco(char *cfgfile, char *weightfile)
{
    ...
    char *base = "results/";
    listc *plistc = get_paths("data/coco_val_5k.list");
    //listc *plistc = get_paths("/home/pjreddie/data/people-art/test.txt");
    //listc *plistc = get_paths("/home/pjreddie/data/voc/test/2007_test.txt");
    char **paths = (char **)list_to_array(plistc);
